import{i as n}from"./index-CGOILWum.js";function g(d,c){const $=d.windows.get("mail");if($)return d.open($.options);const s=document.createElement("div");s.className="mail-app",s.innerHTML=`
